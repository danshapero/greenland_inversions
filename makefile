...
clean:
	rm -rf ExtrudeMesh scripts/*.pyc elmer/*.pyc meshes/*.pyc dems/*.pyc data/helheim/ data/kangerd/ data/jakobshavn/ dems/helheim/ dems/kangerd/ dems/jakobshavn/ meshes/helheim/*.1* meshes/helheim/*.2* meshes/kangerd/*.1* meshes/kangerd/*.2* meshes/jakobshavn/*.1* meshes/jakobshavn/*.2* elmer/helheim/ elmer/helheim3d/ elmer/kangerd/ elmer/kangerd3d elmer/jakobshavn elmer/jakobshavn3d lib/* *.dat *.out
