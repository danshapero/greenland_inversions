...
# ---------------------------------------------------------------------------- #
def get_variable(variable, directory, filename, partitions)                    #
# ---------------------------------------------------------------------------- #
    """
    ...
    for p in range(partitions):
        ...
        node_file = open(parts_directory + "part." + str(p + 1)
                            + "/part." + str(p + 1) + ".nodes")
        points = nodefile.readlines()
        ...
        data = np.zeros(data, order = ['x', 'y', 'z'])
        return data
